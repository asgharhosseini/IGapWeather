package ir.ah.igapweather.ui.nextweather.viewmodel
...
import ir.ah.igapweather.ui.nextweather.NextWeatherViewModel
...
class NextWeatherViewModelTest{
    ...
    @Inject
    lateinit var nextWeatherRepository: NextWeatherRepository
    ...
    fun setUp() {
        ...
        nextWeatherViewModel = NextWeatherViewModel(mainCoroutineDispatcher, nextWeatherRepository)
    }
